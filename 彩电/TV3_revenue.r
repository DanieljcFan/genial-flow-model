...
# #各省产量加总
# index <- grep('产量.彩电', names(chain_season))
# chain_season$彩电产量 <- rowSums(chain_season[,index])
# chain_season <- chain_season[,-index]
# 
# #补充变量
# tmp <- read.csv('彩电营收.csv')
# names(tmp)[1] <- 'time'
